...
#
# Script generated by Vivado on Sun Dec 22 14:55:00 -0800 2024
# SW Build 5164865 on Thu Sep  5 14:37:11 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : j1_memory.sh
...
#
# Usage        : j1_memory.sh
#                j1_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                j1_memory.sh [-reset_run]
#                j1_memory.sh [-reset_log]
#                j1_memory.sh [-help]
#
...
# script info
echo -e "j1_memory.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./j1_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot j1_memory xil_defaultlib.j1_memory xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim j1_memory -key {Behavioral:sim_1:Functional:j1_memory} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb j1_memory.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./j1_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: j1_memory.sh [-help]\n\
Usage: j1_memory.sh [-step]\n\
Usage: j1_memory.sh [-lib_map_path]\n\
Usage: j1_memory.sh [-reset_run]\n\
Usage: j1_memory.sh [-reset_log]\n\
Usage: j1_memory.sh [-keep_index]\n\
Usage: j1_memory.sh [-noclean_files]\n\n\
