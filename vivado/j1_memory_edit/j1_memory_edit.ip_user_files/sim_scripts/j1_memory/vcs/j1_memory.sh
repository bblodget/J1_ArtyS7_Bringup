...
#                script (type 'j1_memory.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.j1_memory xil_defaultlib.glbl -o j1_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./j1_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key j1_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc j1_memory_simv.daidir vcs_lib c.obj)
