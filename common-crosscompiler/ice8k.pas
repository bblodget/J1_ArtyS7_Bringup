...
begin
  ...
  // Add single-step functionality
  repeat
    key := ReadKey;
    case key of
      'q', 'Q': halt;  // Quit immediately
      'n', 'N': break; // Continue to next instruction
    end;
  until false;
end;
...
begin
  ...
  else repeat cpu_step; until false; // Remove ESC check since we handle quit in printstate
